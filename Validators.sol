...
contract Validators is Params, Ownable {
    ...
    //total stakers including validators
    ...
    function stake(address validator)
        ...
        returns (bool)
    {
        require(msg.sender == stakingAddress, "No direct call");
    ...
    function setStakingContract(address payable _staking) external onlyOwner
    {
